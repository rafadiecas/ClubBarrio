...
class AdminRequiredMiddleware(MiddlewareMixin):
    def process_view(self, request, view_func, view_args, view_kwargs):
        ...
        if 'editar' in url_path and request.user.rol == 'Tutor':
            return None
        elif 'administrador' in url_path:
            ...
            return login_required(user_required(rol_requerido('Usuario', 'Tutor', 'Jugador')(view_func)))(request,
                                                                                                          *view_args,
                                                                                                          **view_kwargs)